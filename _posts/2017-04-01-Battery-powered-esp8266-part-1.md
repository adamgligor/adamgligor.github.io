...
I wanted a thermometer to measure the temperature outside that would store the collected data, that did require drilling holes and runing wires through the house. No being able to find anything in the local shops to fulfill these requirements I set out to build one myself. This will be a post on esp8266 and how to run it on battery


## Esp what ?


First challange was finding a device capable of connecting to the internet and commanding a few sensors. Most techies heared of adruino, raspbery pi but this project required something far more basic. Alter doing the research i stumbled upon ESP8266. This is a chinese device with wifi, tcp stack, high level programming language all in a very compact package. 
...
There are already a couple of versions of the device ot there and even more prototype boards. 



I found this very article that lists most common esp8266 variants:   
